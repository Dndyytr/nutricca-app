...
export const LanguageToggle = () => {
  ...
  return (
    <div className="group relative">
      ...
      >
        <span
          className={`absolute inset-y-0.5 left-0.5 flex w-6.5 bp360:w-6.75 bp400:w-7 md:w-7.25 lg:w-7.5 xl:w-8 2xl:w-8.5 items-center justify-center rounded-full bg-green-600 t-size1 font-bold text-white shadow-sm transition-transform duration-350 ease-[cubic-bezier(0.34,1.56,0.64,1)] ${
