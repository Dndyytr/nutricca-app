...
export const LEVEL_CONFIG = {
  beginner: {
    ...
    groups: [
      {
        section: "Dips",
        items: [{ id: "dips", name: "Dips", reps: 15, sets: 3, days: 5 }],
      },
      {
        section: "Pull Up",
        items: [
  ...
  intermediate: {
    ...
    groups: [
      {
        section: "Dips",
        items: [{ id: "dips", name: "Dips", reps: 20, sets: 4, days: 5 }],
      },
      {
        section: "Pull Up",
        items: [
  ...
  advanced: {
    ...
    groups: [
      {
        section: "Dips",
        items: [{ id: "dips", name: "Dips", reps: 25, sets: 5, days: 5 }],
      },
      {
        section: "Pull Up",
        items: [
